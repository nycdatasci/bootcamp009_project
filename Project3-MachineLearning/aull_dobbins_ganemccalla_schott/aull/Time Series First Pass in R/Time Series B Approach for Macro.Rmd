...
rm(price)
macro$price_doc = log(macro$price_doc)
macro$full_sq = log(macro$full_sq)
...
VARselect(dly_complete_stand_data[,2], lag.max = 200, type = "both", exogen = dly_complete_stand_data[,3:6])
...
var_13_dly = VAR(dly_complete_stand_data[,2], p = 13, type = "both", exogen=dly_complete_stand_data[,3:6])
