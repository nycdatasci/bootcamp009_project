...
#how rachel reads in data
sberCC <- read.csv("~/Documents/NYCDSA/Projects/bootcamp009_project/Project3-MachineLearning/jackenyeart_rachelkogan_clairevignonkeser/train_cleaned.csv", stringsAsFactors=FALSE)
sberCC <- sberCC[complete.cases(sberCC),]
