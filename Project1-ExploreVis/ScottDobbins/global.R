...
WW1_unique_target$tooltip <- paste0('On ', WW1_unique_target$MSNDATE, ' during the ', WW1_unique_target$TAKEOFFTIME, ",<br><br><br>", WW1_unique_target$NUMBEROFPLANESATTACKING, ' ', WW1_unique_target$SERVICE, ' ', WW1_unique_target$MDS, 's dropped ', WW1_unique_target$BOMBLOAD, ' lbs of bombs on ', WW1_unique_target$TGTTYPE, ' in ', WW1_unique_target$TGTLOCATION, ', ', WW1_unique_target$TGTCOUNTRY)
