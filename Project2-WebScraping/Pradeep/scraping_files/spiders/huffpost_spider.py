...
class NypostSpider(XMLFeedSpider):
	name = "huffpost"
	start_urls = ('http://www.huffingtonpost.com/feeds/verticals/politics/news.xml',)
	#iterator = 'iternodes'
	itertag = 'item'	
	...
	def parse_link(self, response):
		...
		p_selector=response.xpath('//div[@class="entry-content entry-content-read-more"]//p/text()')
