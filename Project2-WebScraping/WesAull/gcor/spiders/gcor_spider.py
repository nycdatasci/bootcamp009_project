...
class GcorSpider(Spider):
	...
	def parse_cor(self, response):
		...
		corr_search_url = [('https://www.google.com/trends/correlate/search?e=' + x  +'&t=weekly&p=us') for x in search_terms][0:14] #Creating list of correlated search terms to scrape for their search activity time series.
		...
		item = GcorItem()
		item['assoc_search'] = response.xpath('//div[@class="left results"]/h2/strong/text()').extract()[0]	#Scraping initial search term and noting it for later meta reference.
