...
import scrapy
from newersciencemag.items import NewersciencemagItem

class NewerScienceMagSpider(scrapy.Spider):
	name = 'newsciencemag_spider'
	allowed_urls = ['http://science.sciencemag.org/content']

	start_urls = ['http://science.sciencemag.org/content/by/volume/310',
...
# #direct to the info tab of the cover article:
	...
	def parse_issues(self, response):
		...
		for cover in covers:
			cover_url = cover + '/tab-article-info'
			# print cover_url
